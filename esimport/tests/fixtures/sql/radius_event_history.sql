...
INSERT INTO [dbo].[Radius_Event_History](User_Name, Radius_Event_ID, Organization_ID, Member_ID, NAS_Identifier, Called_Station_Id, VLAN, Calling_Station_Id, Date_UTC)
VALUES
