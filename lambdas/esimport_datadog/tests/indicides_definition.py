account_mapping = {
    "properties": {
        ...
        "NetworkAccessEndDateUTC": {"type": "date"},
        "NetworkAccessStartDateUTC": {"type": "date"},
...
conference_mapping = {
    "properties": {
        ...
        "TaxRate": {"type": "float"},
        "TimeZone": {"type": "keyword", "ignore_above": 32},
        "TotalInputBytes": {"type": "float"},
        "TotalOutputBytes": {"type": "float"},
        "TotalSessionTime": {"type": "float"},
        "UpKbs": {"type": "long"},
...
property_mapping = {
    "properties": {
        "ActiveDevices": {"type": "long"},
        "ActiveMembers": {"type": "long"},
        "Address": {
            "type": "nested",
            "properties": {
...
accounts_template_body = {
    ...
    "mappings": {"account": {"properties": account_mapping["properties"]}},
}
...
sessions_template_body = {
    ...
    "mappings": {"session": {"properties": session_mapping["properties"]}},
}

devices_template_body = {
    "template": "devices*",
    "settings": None,
    "aliases": {"devices-current": {"filter": {"type": {"value": "device"}}}},
    "mappings": {"device": {"properties": device_mapping["properties"]}},
}
...
elevenos_aliases_config = {"device": "devices-current", "session": "sessions-current"}
