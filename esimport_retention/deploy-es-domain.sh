...
if [[ $# -lt 3 ]]
  then
    ...
    echo '$3 - S3 bucket name, will be used as snapshot repository '
    echo '$4 - LambdaRoleArn, optional, needs to grant permission for lambda functions to get access ES Domain '
    exit
fi
